...
const moonLightGUI = gui.addFolder('Moonlight')
moonLightGUI.add(moonLight, 'intensity').min(0).max(1).step(0.001)
moonLightGUI.add(moonLight.position, 'x').min(- 5).max(5).step(0.001)
moonLightGUI.add(moonLight.position, 'y').min(- 5).max(5).step(0.001)
moonLightGUI.add(moonLight.position, 'z').min(- 5).max(5).step(0.001)
